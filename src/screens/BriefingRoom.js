...
function BriefingRoom({ usname, navigation, navigateToManeuver }) {
  ...
  return (
    <View style={styles.rootContainer}>
      ...
      <GraphAltitude width={400} height={300} _min={2500} _max={5000} Vsubdiv={200} Hsubdiv={10} autosize={true} resolution={10} />
      <GraphSpeed width={400} height={300} _min={10} _max={250} Vsubdiv={200} Hsubdiv={10} autosize={true} resolution={1}/>
    </View>
  );
