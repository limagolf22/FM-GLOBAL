...
class FSConnector {
    constructor(val){
        console.log("youpi");
        this.socket = new WebSocket(val);
        this.socket.onopen = () => {console.log("connection FS established")};
    };
    send(mess) {
...
export var fsconnector = new FSConnector("ws://localhost:9002");
//fsconnector.send("truc");

class XPlaneConnector extends React.Component {
...
export default connect(mapStateToProps)(XPlaneConnector)
